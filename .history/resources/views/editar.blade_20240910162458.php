        ...
        <form method="POST" action="/atualizar/{{$carro->id}}" enctype="multipart/form-data">
            ...
            <div class="md:flex items-center mt-12">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                        ...
                        <input type="file" name="capa" value="{{$carro->f}}"  class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-2 bg-gray-200 border rounded border-gray-200"/>
                    </div>
                </div>
