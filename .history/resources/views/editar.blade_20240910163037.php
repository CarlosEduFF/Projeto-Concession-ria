        ...
        <form method="POST" action="/atualizar/{{$carro->id}}" enctype="multipart/form-data">
            ...
            <div class="md:flex items-center mt-6">
                ...
                <div class="w-full md:w-1/3 flex flex-col mt-4 md:ml-4">
                    ...
                    <input type="text" name="empresa"  placeholder="" class="leading-none text-gray-900 p-2 focus:outline-none focus:border-blue-700 mt-3 bg-gray-200 border rounded border-gray-200" />
                </div>
            </div>
