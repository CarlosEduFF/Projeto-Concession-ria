                ...
                <div
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <div class="flex space-x-2 mt-4">
                            <a href="/editar/{{$carro->id}}"><button class="px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none">Editar</button></a>
